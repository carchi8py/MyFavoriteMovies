...
class LoginViewController: UIViewController {
        ...
        let task = session.dataTaskWithRequest(request) { data, response, downloadError in
            ...
            if let error = downloadError {
                ...
                if let requestToken = parsedResult["request_token"] as? String {
                    ...
                    println("Could not find request_topen in \(parsedResult)")
                }
    ...
    func loginWithToken(requestToken: String) {
        ...
        /* 2. Build the URL */
        let urlString = appDelegate.baseURLSecureString + "authentication/token/validate_with_login" +
    ...
    func getSessionID(requestToken: String) {
        ...
        /* 2. Build the URL */
        let urlString = appDelegate.baseURLSecureString + "authentication/session/new" +
            appDelegate.escapedParameters(methodParameters)
        let url = NSURL(string: urlString)!
